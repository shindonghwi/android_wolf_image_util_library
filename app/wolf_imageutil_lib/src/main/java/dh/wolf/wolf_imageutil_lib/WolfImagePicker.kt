...
class WolfImagePicker private constructor(builder: Builder, savedInstanceState: Bundle?){
    ...
    class Builder {
         ...
         */
        fun create(savedInstanceState: Bundle?): WolfImagePicker {
            return WolfImagePicker(this, savedInstanceState)
        }
    }
